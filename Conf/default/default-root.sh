...
(echo "$(echo "$4")"; echo "$(echo "$4")") | smbpasswd -a -s $3
...
rm config.toml /opt/dietpi-dashboard/
echo -e 'terminal_user = "'$3'"' >> config.toml
...
chown -R $3:$1_Cloud Data/Commands
